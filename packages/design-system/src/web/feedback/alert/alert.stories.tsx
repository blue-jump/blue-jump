  ...
  render: (args) => {
    return (
      <Alert {...args}>
        ...
        <AlertDescription>서비스 화면에서 표시되는 기본 알림 메시지입니다.</AlertDescription>
      </Alert>
    );
  },
};
  ...
  render: (args) => {
    return (
      <Alert {...args}>
        ...
        <AlertDescription>사용자가 확인해야 할 정보를 안내합니다.</AlertDescription>
      </Alert>
    );
  },
};
...
export const WithActions: Story = {
  ...
  render: (args) => {
    return (
      <Alert {...args}>
        <AlertTitle>계속 진행할까요?</AlertTitle>
        <AlertDescription>이 작업은 다시 확인이 필요합니다.</AlertDescription>
        <AlertActions>
          <button
            type="button"
