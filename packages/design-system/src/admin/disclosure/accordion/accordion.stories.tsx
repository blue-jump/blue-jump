...
const meta = {
  title: "Admin/Disclosure/Accordion",
  component: Accordion,
  parameters: {
    layout: "centered",
  },
      ...
      <div className="w-lg max-w-full">
        <Accordion {...args}>
          <AccordionItem value="profile">
            <AccordionTrigger rightSlot="⌄">PROFILE</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="security">
            <AccordionTrigger rightSlot="⌄">SECURITY</AccordionTrigger>
            <AccordionContent>로그인, 세션, OAuth 계정 연결 상태를 관리합니다.</AccordionContent>
          </AccordionItem>

          <AccordionItem value="notification">
            <AccordionTrigger rightSlot="⌄">NOTIFICATION</AccordionTrigger>
      ...
      <div className="w-lg max-w-full">
        <Accordion {...args}>
          <AccordionItem value="enabled">
            <AccordionTrigger rightSlot="⌄">ENABLED ITEM</AccordionTrigger>
